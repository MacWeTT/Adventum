...
const NotFound = () => {
  return <div className="h-screen w-full bg-primary text-secondary ">
        <div>
	...
	<div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      ...
      <div class="max-w-lg">
      <img src="https://gifdb.com/images/file/namaste-indian-woman-bowing-respect-305cw19lqdrg7stw.gif"></img>
