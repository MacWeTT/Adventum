  ...
  return (
    ...
    <div className="flex justify-center items-center bg-transparent border-white border-2 p-4  ">
      <div className="max-w-4xl w-full h-full">
        ...
        <div className="lg:w-3/4 lg:ml-32 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 gap-4  border-white border-2 pt-3 ">
        ...
        <div className=" lg:w-11/12 lg:ml-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 border-white border-2 ">
